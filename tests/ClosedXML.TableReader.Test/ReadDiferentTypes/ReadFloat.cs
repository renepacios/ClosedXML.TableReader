...
{
    public class ReadFloat : IClassFixture<CreateExcelConnectionFixture>
    {
        private readonly XLWorkbook _wb;
        public ReadFloat(CreateExcelConnectionFixture connectionFixture)
        {
        ...
        public void ReadNull_With_Nullable_Types_Work_As_Should()
        {
            ...
            d.Should().NotBeNull();
            d.Float.Should().BeNull();
            d.Float.Should().Be((float?)null);
        ...
        public void ReadBigger_Work_As_Should()
        {
            ...
            d.Should().NotBeNull();
            d.Float.Should().Be(float.MaxValue);
        ...
        public void ReadNegative_Work_As_Should()
        {
            ...
            d.Should().NotBeNull();
            d.Float.Should().Be(float.MinValue);
