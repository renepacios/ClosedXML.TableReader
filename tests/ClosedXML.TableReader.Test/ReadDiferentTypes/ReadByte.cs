...
{
    public class ReadByte : IClassFixture<CreateExcelConnectionFixture>
    {
        private readonly XLWorkbook _wb;
        public ReadByte(CreateExcelConnectionFixture connectionFixture)
        {
        ...
        public void ReadBigger_Work_As_Should()
        {
            ...
            d.Should().NotBeNull();
            d.Byte.Should().Be(byte.MaxValue);
        ...
        public void ReadMin_Work_As_Should()
        {
            ...
            d.Should().NotBeNull();
            d.Byte.Should().Be(byte.MinValue);
